...
const SAMPLE_PROMPTS = [
  '相手:「来週の打ち合わせ、火曜14時でどうですか？」\n私の意図: その時間は難しいので木曜16時を提案したい\n条件: 丁寧なビジネス文、80文字以内',
  '相手:「今月の飲み会来られる？」\n私の意図: 今回は不参加、次回は参加したい気持ちを伝えたい\n条件: 角が立たないカジュアル文',
  '相手:「資料まだですか？今日中にもらえると助かります」\n私の意図: 遅れてしまったことを謝って、20時までに送ると伝えたい\n条件: 誠実で簡潔',
  '相手:「先日はありがとうございました！」\n私の意図: お礼を返しつつ、来週の再訪問日程を相談したい\n条件: 丁寧、前向き、120文字以内',
]
