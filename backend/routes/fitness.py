...
fitness_home = make_session_init_route(
    blueprint=fitness_bp,
    route_path="/fitness",
    frontend_path="/fitness",
    endpoint_name="fitness_home",
    reset_session=lambda session_id: redis_client.reset_session(session_id),
)

fitness_send_message = make_chat_send_message_route(
    blueprint=fitness_bp,
    route_path="/fitness_send_message",
    mode="fitness",
    error_responder=error_response,
    endpoint_name="fitness_send_message",
